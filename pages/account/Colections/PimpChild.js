...
function PimpChild({ userToken, successRes }) {
  ...
  async function getMegaNFT() {
    ...
    try {
      const response = await contract.getMegaNFTs(6, 10);
  ...
  return (
    <>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-12 gap-10">
        {/* Balance NFT 10 */}
        {balanaceNFT > 9 && usePimpList.map((item) => (
