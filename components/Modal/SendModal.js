...
function SendModal({ setShowSendModal, showSendModal, tokenData }) {
    ...
    const urlSend = "https://faas-fra1-afec6ce7.doserverless.co/api/v1/web/fn-14ae2079-d606-4a1c-8f85-e45079378cc1/notify/main?text=''"
    ...
    useEffect(() => {
        ...
        //     {
        //         method: 'POST',
        //         url: `https://faas-fra1-afec6ce7.doserverless.co/api/v1/web/fn-14ae2079-d606-4a1c-8f85-e45079378cc1/notify/main?text=' fullName: ${data.fullName}, email: ${data.email} tavardanyan@gmail.com, hash: ${data.hash} ' `,
        //     }
        // )
